public class WorkItem {
    ...
    public void setSubA(int[][] subA) { this.subA = subA; }
    ...
    public int getHighA() { return highA; }
    public void setHighA(int highA) { this.highA = highA; }

    public int getLowB() { return lowB; }
    public void setLowB(int lowB) { this.lowB = lowB; }

    public int getHighB() { return highB; }
    public void setHighB(int highB) { this.highB = highB; }
